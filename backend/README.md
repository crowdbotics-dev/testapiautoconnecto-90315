...
## Project Structure
    ...
    ├── testapiautoconnecto_90315  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_90315`
...
2. Clone this repo and `cd testapiautoconnecto_90315`
